...
export const COMMAND_ROUTES: CommandRoute[] = [
  ...
  { key: "r:archive-program-development", group: "연구 · 아카이브", label: "프로그램 설계·개발", sub: "ADDIE · 가네 9절차 셀프 가이드", href: "/archive/program-development", icon: Blocks, keywords: "프로그램 설계 개발 교육훈련 addie 분석 설계 개발 실행 평가 교수설계 instructional design program development 연수 hrd 수업설계 교육 훈련 프로그램 개발 모형 가네 9절차 9가지 교수절차 수업 사태 gagne 학습목표 과정안 lesson plan mager", visibility: "both" },
