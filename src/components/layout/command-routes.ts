...
export const COMMAND_ROUTES: CommandRoute[] = [
  ...
  { key: "r:steppingstone-program-development", group: "대학원 생활", label: "교육훈련 프로그램 개발 가이드", sub: "ADDIE 5단계 셀프 가이드", href: "/steppingstone/program-development", icon: Blocks, keywords: "교육훈련 프로그램 개발 addie 분석 설계 개발 실행 평가 교수설계 instructional design program development 연수 hrd 수업설계 교육 훈련 프로그램 개발 모형", visibility: "both" },
