...
const SEED_WRITING_TIPS: SeedEntry[] = [
  ...
  {
    title: "직접 인용은 최소화 — 큰따옴표는 예외일 때만",
    category: "academic-convention",
    wrongExample:
      "선행연구에서는 \"스마트폰 과의존은 청소년의 학업 집중도를 저하시킨다\"고 하였다(이연구, 2021).",
    correctExample:
      "이연구(2021)에 의하면 스마트폰 사용을 스스로 조절하지 못하는 청소년일수록 수업 중 집중을 유지하기 어려운 경향이 있다.",
    explanation:
      "원문을 큰따옴표로 그대로 옮기는 직접 인용이 많으면 '논문을 충분히 소화하지 못했다'고 평가될 수 있어 일반적으로 최소화합니다. 직접 인용은 법률 조항·공식 정의·특정 개념의 최초 정의처럼 원문 표현을 바꾸면 의미가 달라지는 경우에만 예외적으로 사용하는 것이 권장됩니다. 그 외에는 이해한 내용을 내 언어로 다시 쓰는 간접 인용이 기본입니다.",
    accessibleSummary:
      "큰따옴표로 그대로 베끼는 인용은 꼭 필요한 경우(법조항·공식 정의 등)만. 평소엔 내 말로 바꿔 쓰는 것이 기본입니다.",
    tags: ["인용", "직접인용", "간접인용", "표절"],
    additionalExamples: [
      "직접 인용 허용 예외: 법률 조항·공식 정의·특정 개념의 최초 정의",
      "직접 인용 시에는 쪽수(p./pp.)를 함께 표기",
    ],
  },
  {
    title: "간접 인용은 단어가 아니라 문장 전체를 내 말로",
    category: "academic-convention",
    wrongExample:
      "스마트폰에 지나치게 의존하는 것은 청소년의 수업 집중력을 떨어뜨리고 학습 참여 동기를 낮추는 것으로 확인되었다(이연구, 2021).",
    correctExample:
      "이연구(2021)에 따르면 스마트폰 사용을 스스로 통제하기 어려운 청소년일수록 수업에 집중하거나 학습 활동에 능동적으로 참여하려는 의지가 낮아지는 경향이 있다.",
    explanation:
      "출처를 달았더라도 원문과 문장 구조가 같고 단어만 유의어로 바꾸면 표절로 간주됩니다. 간접 인용의 핵심은 단어 치환이 아니라 문장 구조를 완전히 바꾸고 내용을 내 이해로 재구성하는 것입니다. 출처는 간접 인용에서도 반드시 표기합니다.",
    accessibleSummary:
      "유의어로 단어만 바꾸면 출처를 달아도 표절입니다. 문장 구조까지 통째로 바꿔 내 문장으로 다시 쓰세요.",
    tags: ["인용", "간접인용", "표절", "패러프레이즈"],
    additionalExamples: [
      "원문 5~10회 정독 → 원문 닫기 → 내 말로 설명 → 원문과 대조 → 출처 표기",
      "내 말로 바꾸는 자세한 방법은 인용 가이드(/archive/citation-guide) 참고",
    ],
  },
  {
    title: "재인용은 최후 수단 — 원본 직접 확인이 기본",
    category: "academic-convention",
    wrongExample:
      "Vygotsky(1978)는 근접발달영역을 ~로 정의하였다(이연구, 2021에서 재인용).",
    correctExample:
      "Vygotsky(1978)는 근접발달영역을 ~로 정의하였다. (원본을 직접 확인하여 인용)",
    explanation:
      "재인용(2차 인용)은 원본을 끝내 구할 수 없을 때에 한해 사용하는 최후 수단입니다. 원칙적으로 원본을 직접 읽고 확인하여 인용하는 것이 학문적 정확성의 기본입니다. 재인용의 구체적 표기 형식은 학술지·소속 대학원 지침에 따라 다를 수 있으므로 지침을 확인하세요.",
    accessibleSummary:
      "남이 인용한 것을 그대로 받아 쓰는 재인용은 원본을 못 구할 때만. 가능하면 원본을 직접 찾아 확인하세요.",
    tags: ["인용", "재인용", "2차인용"],
    additionalExamples: [
      "재인용 표기 형식은 소속 지침 확인 필요",
    ],
  },
];
