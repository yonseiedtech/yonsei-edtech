...
export const CONSENT_SUMMARIES: Record<ConsentKey, { oneLine: string; body: string }> = {
  ...
  privacy: {
    ...
    body:
      "학회는 회원 관리, 세미나·학술활동 운영, 수료증 발급, 맞춤 안내 및 서비스 개선을 위해 필수 항목(이름·이메일·학번·생년월일·입학 시점 등)과 선택 항목(연락처·소속·관심분야·프로필 사진 등)을 수집·이용합니다. 회원이 서비스를 이용하며 남긴 학습활동 기록(학습 잔디·논문 읽기·진단평가)도 함께 처리됩니다. 개인정보는 제3자에게 제공하지 않으며, 회원 탈퇴 또는 관련 법령에 따른 보관기간 경과 시 지체없이 파기됩니다. 이용자는 언제든 열람·정정·삭제·처리정지를 요청할 수 있습니다.",
  },
  collection: {
    oneLine: "회원가입 및 서비스 제공을 위해 아래 개인정보를 수집·이용합니다.",
    body:
      "수집항목: 이름·학번·이메일·비밀번호·생년월일·입학 시점(필수), 연락처·소속·직책·관심분야·프로필 사진(선택), 학습활동 기록(학습 잔디·논문 읽기·진단평가) 및 약관 동의 이력. 수집목적: 회원 식별 및 관리, 세미나/활동 참가, 수료증 및 증빙 발급, 맞춤 안내, 서비스 개선. 보유기간: 회원 탈퇴 시까지 또는 법령에 따른 기간. 제3자 제공은 하지 않습니다. 동의를 거부할 권리가 있으나 필수항목 미동의 시 서비스 이용이 제한됩니다.",
  },
  marketing: {
