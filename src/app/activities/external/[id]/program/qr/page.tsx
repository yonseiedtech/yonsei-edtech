...
import ConferenceCheckinQrBoard from "@/features/conference/ConferenceCheckinQrBoard";
...
export default function Page({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-4 px-4 py-6 print:max-w-none print:px-0 print:py-0">
      <ConferenceCheckinQrBoard activityId={id} activityTitle={activity?.title ?? ""} />
    </div>
  );
}
