  ...
  return (
    <Section title="인사말">
      <div className="space-y-4">
        <PersonGreetingForm label="주임교수 인사말" value={advisorForm} onChange={setAdvisorForm} optional />
        <PersonGreetingForm label="학회장 인사말" value={presidentForm} onChange={setPresidentForm} />
      </div>
