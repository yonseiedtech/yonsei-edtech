    ...
    return [
      {
        ...
        label: "대학원 생활",
        href: "/gatherings",
        cardClass: "from-info/10 to-info/[0.02] border-info/30",
      ...
      },
      {
        ...
        cardClass: "from-cat-5/10 to-cat-5/[0.02] border-cat-5/30",
        iconClass: "bg-cat-5/15 text-cat-5",
        accentText: "text-cat-5",
      ...
      },
      {
        ...
        label: "학술 활동",
        href: "/seminars",
        cardClass: "from-success/10 to-success/[0.02] border-success/30",
