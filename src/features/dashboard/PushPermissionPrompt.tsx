...
/**
 * Web Push 권한 요청 prompt — Sprint 53
 *
 * 표시 조건:
...
export default function PushPermissionPrompt() {
  ...
  return (
    <div className="mx-auto mt-3 max-w-6xl px-4">
      <div className="flex flex-col gap-3 rounded-2xl border border-blue-200 bg-blue-50/60 px-4 py-3 sm:flex-row sm:items-center">
        <div
          className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-blue-100 text-blue-700"
          aria-hidden="true"
        >
          <Bell size={20} />
        </div>
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <button
            type="button"
            onClick={dismiss}
            className="inline-flex h-9 items-center gap-1 rounded-lg px-2 text-xs text-blue-700 hover:bg-blue-100"
