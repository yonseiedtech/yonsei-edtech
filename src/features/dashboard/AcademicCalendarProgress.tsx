...
const PHASE_COLORS: Record<SemesterPhase, string> = {
  before: "bg-slate-200 text-slate-700",
  regular_pre_midterm: "bg-emerald-100 text-emerald-700",
  midterm: "bg-rose-100 text-rose-700",
  regular_post_midterm: "bg-emerald-100 text-emerald-700",
  final: "bg-rose-100 text-rose-700",
  post_final: "bg-amber-100 text-amber-700",
  break: "bg-sky-100 text-sky-700",
  after: "bg-slate-200 text-slate-700",
};
