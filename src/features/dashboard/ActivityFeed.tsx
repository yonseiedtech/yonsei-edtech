    ...
    <div className="relative ml-3">
      ...
      {recentComments.map((c, idx) => {
        ...
        return (
          ...
          >
            {/* 아바타 (타임라인 노드) */}
            <div className="absolute left-0 flex h-7 w-7 shrink-0 items-center justify-center rounded-full border-2 border-white bg-info/15 text-info dark:border-card">
