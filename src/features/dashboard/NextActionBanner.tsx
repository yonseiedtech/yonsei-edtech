...
export default function NextActionBanner() {
  ...
  if (hidden) {
    return (
      <div className="mx-auto flex max-w-6xl items-center justify-end px-4">
        <button
          type="button"
          onClick={show}
  ...
  return (
    <div className="mx-auto max-w-6xl px-4">
      <Link
        href={top.href}
        className={cn(
          "group flex items-center gap-2 rounded-2xl border px-3 py-1.5 shadow-sm transition-colors hover:bg-muted/30 sm:gap-3 sm:py-2",
          urgent,
        )}
        role="status"
