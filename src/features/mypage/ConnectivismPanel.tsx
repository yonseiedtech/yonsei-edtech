    ...
    >
      ...
      <div className="mt-4 grid gap-2 sm:grid-cols-3">
        <div className="flex items-start gap-2 rounded-2xl border bg-card p-3">
          <Users size={14} className="mt-0.5 shrink-0 text-cat-1" aria-hidden />
          <div>
        ...
        <div className="flex items-start gap-2 rounded-2xl border bg-card p-3">
          <Users size={14} className="mt-0.5 shrink-0 text-success" aria-hidden />
          <div>
        ...
        <div className="flex items-start gap-2 rounded-2xl border bg-card p-3">
          <Users size={14} className="mt-0.5 shrink-0 text-warning" aria-hidden />
          <div>
