...
const AXES: AxisDef[] = [
  {
    ...
    Icon: Brain,
    dotActive: "bg-cat-1",
    dotInactive: "bg-cat-1/10",
    border: "border-cat-1/20",
    bg: "bg-cat-1/5",
    iconBg: "bg-cat-1/10",
    iconFg: "text-cat-1",
    labelColor: "text-cat-1",
  ...
  },
  {
    ...
    Icon: Target,
    dotActive: "bg-success",
    dotInactive: "bg-success/10",
  ...
  },
  {
    ...
    Icon: TrendingUp,
    dotActive: "bg-warning",
    dotInactive: "bg-warning/10",
  ...
  },
  {
    ...
    Icon: Star,
    dotActive: "bg-cat-4",
    dotInactive: "bg-cat-4/10",
    border: "border-cat-4/20",
    bg: "bg-cat-4/5",
    iconBg: "bg-cat-4/10",
    iconFg: "text-cat-4",
    labelColor: "text-cat-4",
    actionHref: "/board",
