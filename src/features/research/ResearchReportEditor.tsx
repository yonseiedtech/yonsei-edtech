...
const STEPS = [
  {
    ...
    hints: [
      "학습자(누가) · 교육 형식(어떻게) · 과목 또는 주제(무엇)를 먼저 정의해 주세요.",
      "그다음 현장에서 관찰되는 ‘현상 → 근거 → 원인 → 영향 → 중요성’ 순서로 한 카드씩 채우면 자연스럽게 이어집니다.",
  ...
  },
  {
    ...
    hints: [
      "이론 카드에 이름 · 학자 · 연도 · 핵심 개념 · 선택 이유 · 문제 연결을 적어주세요.",
      "여러 이론을 결합한다면 ‘이론 간 관계’ 3필드(공통 문제 · 역할 분담 · 통합 시각)도 함께 채워주세요.",
      "이론은 한 개부터 시작해도 좋습니다. 카드는 언제든지 추가하거나 삭제할 수 있습니다.",
    ],
  },
  {
    key: "prior",
    ...
    hints: [
      "‘논문 읽기’에 미리 등록해 둔 선행연구를 검색해서 추가하세요.",
      "관련 논문들을 그룹으로 묶고, 그룹별로 통합 해석과 시사점을 정리하면 분석이 깔끔해집니다.",
